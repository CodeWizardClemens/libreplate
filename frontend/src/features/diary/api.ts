    ...
    mutationFn:
      async (
        ...
        const {
          ...
          await mealFoodApi.post<MealFood>(
            "",
            mealFood,
          );
...
export function useCreateDefaultMeal() {
  ...
  return useMutation({
    ...
    mutationFn:
      async (
        meal: DefaultMealCreate,
      ) => {

        const {
          data,
        } =
          await api.post<DefaultMeal>(
            "defaults/",
            meal,
          );
