...
export default function RecipeCardActions({
  ...
  const actions = (
    <>
      ...
      <button
        ...
        title="Favorite"
      >
        <i className={recipe.is_favorite ? "bi bi-star-fill" : "bi bi-star"} />
      </button>

      <button className="btn btn-outline-primary" onClick={onCopy} title="Copy">
  ...
  return (
    <>
      {/* Desktop */}
      <div className="col-12 col-md-auto d-none d-md-flex gap-2 order-3">{actions}</div>
